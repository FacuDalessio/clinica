...
This skill covers Spring Boot development including REST APIs, security configuration, data access, actuator monitoring, and cloud integration. Follows **Spring Boot 4.0.x** patterns (Spring Framework 7, Jakarta EE 11, **Java 25**) with emphasis on production readiness.

## When to Use This Skill

Use when you need to:
- Create REST APIs with Spring MVC/WebFlux (Spring Boot 4.0+)
- Configure Spring Security (OAuth2, JWT) with SecurityFilterChain
- Set up database access with Spring Data JPA
- Enable monitoring with Actuator
- Integrate with Spring Cloud

**Project context:** Java 25, Spring Boot 4.0.2, Maven, spring-boot-starter-webmvc
