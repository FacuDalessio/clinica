...
This skill covers Java testing with JUnit 5, Mockito, AssertJ, and integration testing with Spring Boot Test and Testcontainers. Targets **Java 25** and **Spring Boot 4.0.x** test slices. Includes TDD patterns and test coverage strategies.

## When to Use This Skill

Use when you need to:
- Write unit tests with JUnit 5 (Java 25)
- Create mocks with Mockito
- Build integration tests with Testcontainers
- Implement TDD/BDD practices
- Test Spring Boot 4.0.x applications (@SpringBootTest, @WebMvcTest)
- Improve test coverage

**Project context:** Java 25, Spring Boot 4.0.2, spring-boot-starter-*-test, Maven
